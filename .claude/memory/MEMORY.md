...
- [Auto-resize dpr-flicker collapse](auto_resize_dpr_flicker_collapse.md) — widget shrinks to header sliver = WebView2 devicePixelRatio flapping 1.5↔1.0; fix = scale hysteresis in App.svelte resolveScale + minWidth floor + overflow-x:hidden
