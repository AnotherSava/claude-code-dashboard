...
- [Auto-resize dpr-flicker collapse](auto_resize_dpr_flicker_collapse.md) — widget shrinks to header sliver = WebView2 devicePixelRatio misreading 1.5→1.0 (holds tens of sec, not a flicker); fix = size against Rust window.scale_factor() returned from apply_auto_resize + get_scale_factor mount seed, NOT devicePixelRatio; hysteresis was insufficient, removed
